...
const Dashboard = () => {
  ...
  const fetchMessages = () => {
    ...
    dispatch(getChatMessages({ chatId: activeChat.group_id, page})).then((result) => {
      ...
      setMessages((prevMessages) =>
        page === 1 ? response : [...prevMessages, ...response]
      );
    });
  };
          ...
          >
            <div>
              ...
              <div className=" py-5 bg-chatBg w-full">
                <div
                  className="h-[66vh] overflow-y-scroll px-4"
                      ...
                      messages
                        ...
                        .map((message, idx) =>
                          message.sender === user.username ? (
                            ...
                            >
                              <p className="pe-4 text-sm">{message.content}</p>
                            ...
                            <div
                              key={idx}
                              className="border-2  border-primary shadow-slate-400 shadow-sm bg-white px-3 pt-1 pb-1 max-w-[15rem] lg:max-w-lg md:max-w-sm sm:max-w-sm my-2 rounded-md"
                            >
