      ...
      <div className="relative isolate px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl py-20 sm:py-28 lg:py-28">
          <div className="text-center">
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
            ...
            <p className="mt-6 text-sm md:text-lg leading-7 md:leading-8 text-gray-600">
