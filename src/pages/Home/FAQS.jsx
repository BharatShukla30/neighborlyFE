...
const FAQS = () => {
    const [faqs, setFaqs] = useState([
        {
          question: "Q. Why should I use Neighborly when I already have Facebook Groups, WhatsApp, or Reddit?",
        ...
        {
          question: "Q. How is Neighborly’s dynamic feed different from other social media platforms?",
        ...
        {
          question: "Q. If I’ve already created a WhatsApp group with my neighborhood tribe, why should I return to Neighborly?",
        ...
        {
          question: "Q. How does Neighborly manage trolls and bad users?",
        ...
        {
          question: "Q. How is Neighborly different from Reddit, and isn’t it just a less popular version?",
        ...
        <div className='p-2 m-3'>
          ...
          {faqs.map((faq, index) => (
            <div
              ...
              className="rounded-sm cursor-pointer mb-2"
            >
              <div className="text-base bg-indigo-400 font-semibold p-2 text-white rounded-md">
                {faq.question}
              </div>
              {faq.open && (
                <div className="text-base p-3 border-l-4 border-indigo-800 bg-indigo-100 rounded-b-2xl">
                  {faq.answer}
                </div>
              )}
            </div>
